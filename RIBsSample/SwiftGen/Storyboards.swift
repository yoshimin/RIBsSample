...
internal enum StoryboardScene {
  internal enum Item: StoryboardType {
    internal static let storyboardName = "Item"

    internal static let initialScene = InitialSceneType<RIBsSample.ItemViewController>(storyboard: Item.self)
  }
